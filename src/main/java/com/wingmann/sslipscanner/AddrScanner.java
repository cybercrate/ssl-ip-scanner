...
public class AddrScanner {
    private final CloseableHttpClient httpClient;
    private final RequestConfig requestConfig;

    public AddrScanner() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
    ...
    public void scan(String ip, int threadsCount) throws InterruptedException {
        ...
        List<ThreadedAddrScan> threads = new ArrayList<ThreadedAddrScan>();
        ...
        for (int i = 0; i < threadsCount; i++) {
            ...
            ThreadedAddrScan thread = new ThreadedAddrScan(httpClient, requestConfig, threadIps);
            threads.add(thread);
